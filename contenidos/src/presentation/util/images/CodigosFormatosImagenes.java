...
/**
 * Clase de constantes que nos ayuda a mantener algunos codigos de formatos
 * graficos utiles para las comparaciones.
 */
public class CodigosFormatosImagenes {
	...
	/**
	 * Codigo para el formato JPG en minusculas - Joint Photographic Experts
	 * Group .
	 */
	public static final String CODIGO_FORMATO_JPG_MINUSC = "jpg";

	/**
	 * Codigo para el formato JPG en mayusculas - Joint Photographic Experts
	 * Group .
	 */
	public static final String CODIGO_FORMATO_JPG_MAYUSC = "JPG";

	/**
	 * Codigo para el formato JPEG en minusculas - Joint Photographic Experts
	 * Group .
	 */
	public static final String CODIGO_FORMATO_JPEG_MINUSC = "jpeg";

	/**
	 * Codigo para el formato JPEG en mayusculas - Joint Photographic Experts
	 * Group .
	 */
	public static final String CODIGO_FORMATO_JPEG_MAYUSC = "JPEG";

	/**
	 * Codigo para el formato WBMP en mayusculas - Wireless Application Protocol
	 * Bitmap Format .
	 */
