...
<div class="marco">
	<frm:grid id="gridBackEndGroups"/>
	<%--
	<c:import url="/WEB-INF/jsp/common/tablepager.jsp"></c:import>
	 --%>
</div>

<form name="deleteGroup" action="${pageContext.request.contextPath}/backend/deletegroup.do " method="post">
	<input type="hidden" name="gruPk" />
</form>
